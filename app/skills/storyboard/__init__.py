...
class StoryboardSkill(Skill):
    ...
    def _execute(self, state: VideoState) -> VideoState:
        ...
        prompt = (
            ...
            "   必须包含:画风(如 oil painting / watercolor / digital illustration)、\n"
            "   色调(如 deep teal and warm gold / muted blue-gray with amber accents)、\n"
            "   构图(如 vertical 9:16 composition / cinematic close-up)、\n"
            "   主角外貌一致性(如 the same young woman with long dark hair in a white dress 出现在每一帧)。\n"
            "   这个 visual_style 必须能让所有帧看起来像同一组系列画作。\n\n"
